...
if (!isset($_GET['template_id']) && !isset($template_id)) {
	...
	if ($template->type!='page') {
		wp_die(__('You can only edit page templates in this page', POST_TEMPLATES_I18N_DOMAIN));
	}
...
<h2><?php _e('Write Page Template', POST_TEMPLATES_I18N_DOMAIN) ?></h2>
		...
		<div id="post-body" class="has-sidebar">
			<div id="post-body-content" class="has-sidebar-content">				
				...
				<div id="normal-sortables" class="meta-box-sortables ui-sortable" style="position: relative;">
					...
					<div id="pageparent" class="postbox">
						<div class="handlediv"><br/></div>
						<h3 class="hndle"><?php _e('Page Parent', POST_TEMPLATES_I18N_DOMAIN) ?></h3>
						<div class="inside">
							<p><select name="parent">
								<option value='0'><?php _e('Main Page (no parent)', POST_TEMPLATES_I18N_DOMAIN); ?></option>
								<?php parent_dropdown($template_parent); ?>
							</select></p>
						</div>
					</div>	
					...
					<div id="passworddiv" class="postbox">
						<div class="handlediv"><br/></div>
						<h3 class="hndle"><?php _e('Password Protect This Page', POST_TEMPLATES_I18N_DOMAIN) ?></h3>
